    ...
    <body id="back">
        ...
        <dl id="browse" >
            ...
            <c:forEach items="${gamet}" var="gat">
                ...
                <dd><a href="/GamesShop/Store1/${gat.gameTypeId}">${gat.typeName}</a></dd>
                </c:forEach>
        </dl> 
        <div id="body"> 
